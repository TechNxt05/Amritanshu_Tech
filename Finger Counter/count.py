...
for imPath in myList:
    ...
    # Resize image to match webcam frame dimensions
    resized_image = cv2.resize(image, (overlay_width, overlay_height))
...
while True:
    ...
    if len(lmList) != 0:
        ...
        cv2.putText(img, str(totalFingers), (50, 375), cv2.FONT_HERSHEY_PLAIN,
                    10, (255, 0, 0), 25)
